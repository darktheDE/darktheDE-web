/**
 * Projects — hand-ported from darktheDE-portfolio/src/data/projectsData.js
 * 9 projects across Data Engineering / Software Engineering / Machine Learning.
 */

export type CategoryTag = "Data Engineering" | "Software Engineering" | "Machine Learning";
...
export const projects: Project[] = [
  {
    ...
    description:
      "Built a BigQuery-based financial data warehouse and ML analytics platform for Vietnam's banking sector. Designed star schema layers, Looker Studio dashboards, and model output tables for LSTM forecasting, K-Means bank profiling, and Random Forest credit-risk warning with 0.9752 AUC-ROC.",
  ...
  },
  {
    ...
    categoryTag: "Data Engineering",
    description:
      "Engineered a distributed culinary sentiment analytics platform using a hybrid OLTP/OLAP architecture. Orchestrated TripAdvisor scraping, TheMealDB ingestion, MongoDB/MySQL staging, HDFS storage, 8 Hadoop MapReduce jobs, Hive analytical views, and a Streamlit dashboard.",
  ...
  },
  {
    ...
    description:
      "Built a reproducible benchmark for TurboQuant and KV Cache compression methods on Vietnamese LLMs. The pipeline curates Vietnamese long-context datasets, runs model inference across vLLM/Ollama-style engines, and logs VRAM, latency, throughput, and perplexity trade-offs.",
  ...
  },
  {
    ...
    categoryTag: "Data Engineering",
    description:
      "Architected a decoupled Data Lakehouse environment using Docker to process 100K+ simulated patient records. Engineered Medallion Architecture with Iceberg format and Trino for high-speed BI serving.",
  ...
  },
  {
    ...
    categoryTag: "Data Engineering",
    description:
      "Built a Medallion Architecture on a Dockerized Spark cluster processing 100K+ Brazilian e-commerce records. Implemented automated ETL pipelines with Airflow, Delta Lake, and Superset dashboards.",
  ...
  },
  {
    ...
    categoryTag: "Data Engineering",
    description:
      "Enterprise Data Warehouse correlating 2015 U.S. flight logs with FAA Registry data. Built using Kimball methodology with SSIS incremental loading and SSAS OLAP cubes for sub-second analysis.",
  ...
  },
  {
    ...
    categoryTag: "Data Engineering",
    description:
      "Big Data processing pipeline using PySpark with Medallion Architecture for analyzing NYC taxi trip data. Features Spark Structured Streaming and a data quality framework.",
  ...
  },
  {
    ...
    description:
      "As Project Manager, I led the development of this e-commerce platform, implementing JWT Auth, Google OAuth2, and Product Reviews & Ratings systems using Spring Boot and Next.js.",
  ...
  },
  {
    ...
    categoryTag: "Machine Learning",
    description:
      "ML architecture combining K-Means++, Hierarchical, and DBSCAN clustering using adaptive weighting to classify cancer subtypes from high-dimensional RNA-Seq data.",
...
export const PROJECT_FILTERS: CategoryTag[] | string[] = [
  "All",
  "Data Engineering",
...
export const PROJECT_PROOF: Record<CategoryTag, string> = {
